...
export function ActiveTimer() {
  ...
  const neutralBtn = 'rounded-none border border-gray-300 bg-white px-2 py-1 text-xs text-gray-700 font-mono hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800'
  const primaryBtn = 'rounded-none border border-gray-900 bg-gray-900 px-2 py-1 text-xs text-white font-mono hover:bg-gray-800 dark:border-gray-100 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-200'
  ...
  return (
    <div className="rounded-none border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="mb-1 flex items-center gap-2">
        ...
        <span className="truncate text-sm font-mono font-medium text-gray-800 dark:text-gray-200">{active.title}</span>
      </div>
